...
const FEATURES = [
  ...
  { icon: BookOpen, text: 'Lebih dari 5 bahasa asing tersedia', bg: 'bg-green-100' },
]
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      login(token, user)
      const isDefaultAvatar = !user.avatar_url || user.avatar_url.includes('adventurer')
      navigate(isDefaultAvatar ? '/avatar' : '/dashboard', { replace: true })
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex bg-[#FAF9F6]">
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-black flex-col justify-between p-12 relative overflow-hidden border-r-4 border-black">
        {/* Decorative blocks */}
        <div className="absolute top-8 right-8 w-24 h-24 bg-[#58CC02] border-2 border-white/20 rounded-2xl rotate-12 opacity-30" />
        ...
        <div className="absolute top-1/2 left-8 w-10 h-10 bg-violet-400 border-2 border-white/20 rounded-lg rotate-45 opacity-20" />

        {/* Brand */}
        <div className="relative flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[#58CC02] border-2 border-white flex items-center justify-center shadow-[3px_3px_0px_#fff]">
        ...
        <div className="relative">
          <h2 className="text-4xl font-extrabold text-white leading-tight mb-4">
            Belajar bahasa asing<br />dengan kecerdasan AI
          </h2>
          <p className="text-gray-400 text-sm mb-8 leading-relaxed font-medium">
            Platform belajar bahasa yang membuat jalur belajar personal untukmu secara otomatis.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            <div className="w-9 h-9 rounded-xl bg-[#58CC02] border-2 border-black flex items-center justify-center shadow-[2px_2px_0px_#000]">
          ...
          <div className="mb-8">
            <h1 className="text-2xl font-extrabold text-black">Selamat datang kembali 👋</h1>
            <p className="text-gray-500 font-medium text-sm mt-1">Masuk untuk melanjutkan belajar</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                name="password" type="password" placeholder="Password kamu"
            ...
            <button
              ...
              className="w-full h-11 rounded-xl mt-1 font-extrabold text-sm text-white bg-[#58CC02]
          ...
          <p className="text-center text-sm font-medium text-gray-500">
            Belum punya akun?{' '}
            <Link to="/register" className="font-extrabold text-black underline underline-offset-2 hover:text-[#58CC02] transition-colors">
              Daftar gratis
            </Link>
          </p>
        </div>
